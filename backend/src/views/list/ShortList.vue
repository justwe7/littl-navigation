            ...
            <a-col :md="8" :sm="24">
              <a-form-item label="分类">
                <a-select v-model="queryParam.type" placeholder="请选择" default-value="0">
                  ...
                  <a-select-option value="2">购物</a-select-option>
                  <a-select-option value="3">社交</a-select-option>
                  <a-select-option value="4">娱乐</a-select-option>
                  <a-select-option value="5">工具</a-select-option>
                </a-select>
              </a-form-item>
            </a-col>
